...
export class LinearService {
   ...
   */
  async fileUpload(contentType: string, filename: string, size: number, makePublic?: boolean) {
    try {
      const uploadPayload = await this.client.fileUpload(contentType, filename, size, {
