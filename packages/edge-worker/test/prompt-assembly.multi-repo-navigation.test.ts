...
describe("Prompt Assembly - Multi-Repo Navigation", () => {
	it("emits <multi_repo_navigation> with primary + sibling worktrees for a multi-repo session", async () => {
		...
		const session = {
			...
			workspace: {
				...
				repoPaths: {
					"repo-repoA-uuid": "/worktrees/CEE-200/repoA",
					"repo-repoB-uuid": "/worktrees/CEE-200/repoB",
				},
			},
			metadata: {},
		};
  ...
  <repository name="repoA">
    <working_directory>/worktrees/CEE-200/repoA</working_directory>
    <base_branch>main</base_branch>
  </repository>
  <repository name="repoB">
    <working_directory>/worktrees/CEE-200/repoB</working_directory>
    <base_branch>main</base_branch>
  </repository>
</repositories>
...
This session spans MULTIPLE repositories. Each repo has its own worktree:
  - repoA (primary, your cwd): /worktrees/CEE-200/repoA
  - repoB: /worktrees/CEE-200/repoB
