...
Check workspace isolation
	...
	it("surfaces <sibling_participants> for repos with declared siblings and includes the hard-scope-override clause", () => {
		const coveRepo = {
			...
			workspaceBaseDir: "/test/workspace",
			linearWorkspaceId: "ws-repoA",
			baseBranch: "main",
			githubUrl: "https://github.com/myorg/repoA",
			routingLabels: ["repoA"],
			siblingParticipants: ["repo-repoB"],
			labelPrompts: {
				orchestrator: { labels: ["Orchestrator"] },
			},
		};
		const coveOvhRepo = {
			...
			linearWorkspaceId: "ws-repoA",
			baseBranch: "main",
			githubUrl: "https://github.com/myorg/repoB",
			routingLabels: ["repoB"],
			siblingParticipants: ["repo-repoA"],
		};
		...
		expect(context).toContain(
			`<sibling_participants>"repoB"</sibling_participants>`,
		);
		expect(context).toContain(
			`<sibling_participants>"repoA"</sibling_participants>`,
		);
