...
<verification-command repository="repoA">
...
No comments yet.
	...
	it("emits <verification-command> per repo when only some repos set it (multi-repo)", async () => {
		...
		const repoC = {
			...
			name: "repoDeploy",
			repositoryPath: "/test/repoDeploy",
			baseBranch: "main",
			linearWorkspaceId: "ws-1",
			workspaceBaseDir: "/test/workspaces",
  ...
  <repository name="repoA">
    <working_directory>/test/repoA</working_directory>
    <base_branch>main</base_branch>
  </repository>
  <repository name="repoB">
    <working_directory>/test/repoB</working_directory>
    <base_branch>main</base_branch>
  </repository>
  <repository name="repoDeploy">
    <working_directory>/test/repoDeploy</working_directory>
    <base_branch>main</base_branch>
  </repository>
</repositories>
