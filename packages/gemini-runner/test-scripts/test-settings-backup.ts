...
function readSettings(): object | null {
...
function readBackup(): object | null {
...
console.log("  maxSessionTurns:", (settings1 as any)?.model?.maxSessionTurns);
...
console.log("  maxSessionTurns:", (settings2 as any)?.model?.maxSessionTurns);
console.log("  Expected: 1");
...
console.log(
	...
	(settingsAfterCleanup2 as any)?.model?.maxSessionTurns,
);
...
console.log("  maxSessionTurns:", (settings3 as any)?.model?.maxSessionTurns);
console.log("  Expected: -1");
cleanup3();
