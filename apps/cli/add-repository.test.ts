...
describe('add-repository command', () => {
  ...
  describe('Linear credentials handling', () => {
    it('should detect existing Linear credentials', () => {
      ...
      const repoWithToken = configWithCredentials.repositories.find((r: any) => r.linearToken)
    ...
    it('should handle missing Linear credentials', () => {
      ...
      const repoWithToken = configWithoutCredentials.repositories.find((r: any) => r.linearToken)
    ...
    it('should reuse credentials from existing repositories', () => {
      ...
      const credentialsSource = configWithMultipleRepos.repositories.find((r: any) => r.linearToken)
      ...
      const linearCredentials = {
        ...
        linearWorkspaceName: credentialsSource!.linearWorkspaceName || 'Your Workspace'
      }
