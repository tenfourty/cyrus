...
### F1-harness quirk found while verifying (not a truncation/termination-surfacing bug)
...
- Genuine surprise: F1's own CLI test-harness (`CLIRPCServer.handleViewSession`
  ...
  the real activity had posted correctly. Not a truncation/termination-surfacing defect — a
