...
- Updated `gh-pr.md` subroutine with optional "Deploy Preview" section at the tail end, notifying agents of the available `/deploy-preview` skill for setting up preview environments to test PRs before merging. The section lists use cases including creating preview environments, cloning Supabase projects, creating GitHub apps, and deploying to Vercel. ([CYPACK-846](https://linear.app/ceedar/issue/CYPACK-846), [#898](https://github.com/ceedaragents/cyrus/pull/898))
