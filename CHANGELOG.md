...
- Updated `@anthropic-ai/claude-agent-sdk` from v0.1.69 to v0.1.71 to maintain parity with Claude Code v2.0.71. This update includes support for Zod ^4.0.0 as a peer dependency option, a new AskUserQuestion tool, Windows console visibility fix, and stderr callback bug fix. See the [Claude Agent SDK changelog](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md#0171) for full details. ([CYPACK-618](https://linear.app/ceedar/issue/CYPACK-618))
